...
namespace TRLogicTask
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var from = "cajusterentev@gmail.com";
            var pass = "123123cfy`r123";
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            string AccountSid = "AC9c70c57a0b53812e62fae077a7f15142";

            string AuthToken = "cc63a4cd7a316ffa4696b9297bcbe19f";

            string twilioPhoneNumber = "+18142574155";
